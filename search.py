...
def depthFirstSearch(problem):
    ...
    # while we do not find the goal point
...
def breadthFirstSearch(problem):
    ...
    while not problem.isGoalState(state):
        successors = problem.getSuccessors(state)  # get the point's successors
        for son in successors:
            # if the successor has not been visited,push it into queue
...
def uniformCostSearch(problem):
    ...
    # push the starting point into stack
    # push starting point with priority num of 0
        ...
        for son in successors:
            ...
            for (visitedState, visitedToCost) in visitedList:
                ...
                if (son[0] == visitedState) and (total_cost >= visitedToCost):
                    ...
                    break
            if not visitedExist:  # push the point with priority num of its total cost
                fringe.push((son[0], toDirection + [son[1]],
                             toCost + son[2]), toCost + son[2])
